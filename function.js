...
let progress1 = setInterval(() => {
    ...
    circularProgress1.style.background = `conic-gradient(#7E96A5 ${progressStartValue1 * 3.6}deg, #ededed 0deg)`
...
let progress2 = setInterval(() => {
    ...
    circularProgress2.style.background = `conic-gradient(#7E96A5 ${progressStartValue2 * 3.6}deg, #ededed 0deg)`
...
let progress3 = setInterval(() => {
    ...
    circularProgress3.style.background = `conic-gradient(#7E96A5 ${progressStartValue3 * 3.6}deg, #ededed 0deg)`
...
let progress4 = setInterval(() => {
    ...
    circularProgress4.style.background = `conic-gradient(#7E96A5 ${progressStartValue4 * 3.6}deg, #ededed 0deg)`
